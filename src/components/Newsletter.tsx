  ...
  <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
    ...
    <div className="w-full sm:w-5/12">
      <form className="flex rounded-full bg-slate-800 px-4 py-2 focus-within:ring-2 focus-within:ring-cyan-600 hover:ring-2 hover:ring-cyan-600">
        ...
        <button
          className="ml-2 shrink-0 rounded-full bg-gradient-to-br from-sky-100 to-cyan-100 px-3 py-1 text-sm font-medium hover:from-sky-200 hover:to-cyan-200 focus:outline-none focus:ring-2 focus:ring-cyan-600/50"
          type="submit"
        >
          Subscribe
        </button>
